...
(*
  | limpr : forall ( D F G: list Assignment )( x : Name )( y : nat )( A B : Proposition )( P : Prepro ),
  ...
  | limpl : forall ( D F G F' G': list Assignment )( x : Name )( y : nat )( A B : Proposition )( P Q: Prepro ),
